...
public class CustomPascalCaseStrategy extends PascalCaseStrategy  {
	    ...
	    /**
	     * Adds a special case to PascaCaseStrategy, for XML
	     * namespace elements such as "xml:lang" that appear
	     * in XML documents where the rest of the elements
	     * are in PascalCase.
	     * 
	     * For example:
		 ...
		 * 
		 * We want to convert normal elements to PascalCase, but not
		 * elements in the reserved XML namespace.
	     * 
	     * @param input formatted as camelCase string
	     * @return input converted to PascalCase format, unless the input is in the
	     * reserved XML namespace (e.g., xml:lang) and must remain lowercase.
	     */
	    @Override

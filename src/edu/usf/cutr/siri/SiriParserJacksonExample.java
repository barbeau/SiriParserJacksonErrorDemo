...
/**
 * This class is an example of parsing a JSON respone from a SIRI feed using Jackson
 * 
...
public class SiriParserJacksonExample {
	...
	/**
	 * Takes in a path to a JSON file, parses the contents into a Siri object, 
	 * and prints out the contents of the Siri object.
	 * 
	 * @param args path to the JSON file located on disk
	 */
	public static void main(String[] args) {
		
		if(args[0] == null){
	        System.out.println("Proper Usage is: java JacksonSiriParserExample path-to-JSON-file");
	        System.exit(0);
	    }		
		...
		try {
			...
			/*
			 * Alternately, instead of passing in a File, a String encoded in JSON can be
			 * passed into Jackson for parsing.  Uncomment the below line to read the 
			 * JSON into the String.
			 */			
			//String jsonExample = readFile(file);	
			 ...
			 */
			//Siri = mapper.readValue(jsonExample, Siri.class);
